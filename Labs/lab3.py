...
class WordScramble:
    ...
    #   sys.exit("we would have needed a word a word not a number")

    def scrable(selfself):
        # print what was input
        print("The user input was:", self.user_input)
        ...
        #           temp_word = list(word) # we use a list for item assignment, but could also just use another
        ...
        #               # join the characters together and from the word
        ...
        #           else:
        #               # Since the length of the word < 3 dont swap the word
        #               sentence [index] = word
        #
